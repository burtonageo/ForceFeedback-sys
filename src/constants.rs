...
use cf::{E_FAIL, E_INVALIDARG, E_NOTIMPL, E_NOINTERFACE, E_OUTOFMEMORY, HRESULT, S_OK, S_FALSE};
...
#[macro_export]
macro_rules! kFFEffectType_ConstantForce_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
               0xE5, 0x59, 0xC4, 0x60, 0xC5, 0xCD, 0x11, 0xD6,
               0x8A, 0x1C, 0x00, 0x03, 0x93, 0x53, 0xBD, 0x00));
}

#[macro_export]
macro_rules! kFFEffectType_RampForce_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Square_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Sine_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Triangle_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_SawtoothUp_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_SawtoothDown_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Spring_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Damper_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Inertia_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_Friction_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
...
#[macro_export]
macro_rules! kFFEffectType_CustomForce_ID {
    () => ($crate::CFUUIDGetConstantUUIDWithBytes(ptr::null_mut(),
